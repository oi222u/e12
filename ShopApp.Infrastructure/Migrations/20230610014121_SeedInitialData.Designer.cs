...
namespace ShopApp.Infrastructure.Migrations
{
    ...
    [Migration("20230610014121_SeedInitialData")]
            ...
            modelBuilder.Entity("ShopApp.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 6, 10, 1, 41, 20, 859, DateTimeKind.Utc).AddTicks(5779),
                            Name = "aaa",
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("ShopApp.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 6, 9, 22, 41, 20, 859, DateTimeKind.Local).AddTicks(5862),
                            Description = "fodasi",
                            Name = "product 1",
                            Price = 2131321m,
                            ProductCategoryId = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 6, 9, 22, 41, 20, 859, DateTimeKind.Local).AddTicks(5968),
            ...
            modelBuilder.Entity("ShopApp.Domain.Entities.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "teste",
                            CreatedAt = new DateTime(2023, 6, 9, 22, 41, 20, 859, DateTimeKind.Local).AddTicks(5804)
                        });
                });
            ...
            modelBuilder.Entity("ShopApp.Domain.Entities.Store", b =>
                {
                    ...
                    b.Property<int>("ProductCatalogCount")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Country = "aaaa",
                            CreatedAt = new DateTime(2023, 6, 9, 22, 41, 20, 859, DateTimeKind.Local).AddTicks(5825),
            ...
            modelBuilder.Entity("ShopApp.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 6, 9, 22, 41, 20, 859, DateTimeKind.Local).AddTicks(5562),
                            Email = "aaa",
                            Name = "aaa",
                            Password = "aaa"
                        });
